...
pub const DIAGNOSTICS_RELAY_E_SUCCESS: diagnostics_relay_error_t =
    diagnostics_relay_error_t::Success;
pub const DIAGNOSTICS_RELAY_E_INVALID_ARG: diagnostics_relay_error_t =
    diagnostics_relay_error_t::InvalidArg;
pub const DIAGNOSTICS_RELAY_E_PLIST_ERROR: diagnostics_relay_error_t =
    diagnostics_relay_error_t::PlistError;
pub const DIAGNOSTICS_RELAY_E_MUX_ERROR: diagnostics_relay_error_t =
    diagnostics_relay_error_t::MuxError;
pub const DIAGNOSTICS_RELAY_E_UNKNOWN_REQUEST: diagnostics_relay_error_t =
    diagnostics_relay_error_t::UnknownRequest;
pub const DIAGNOSTICS_RELAY_E_UNKNOWN_ERROR: diagnostics_relay_error_t =
    diagnostics_relay_error_t::UnknownError;
